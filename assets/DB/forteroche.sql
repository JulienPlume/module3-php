...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 20 sep. 2019 à 11:34
...
CREATE TABLE IF NOT EXISTS `comment` (
  ...
  `hiddden` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `comment` (`id`, `id_post`, `author`, `content`, `date`, `signaled`, `approved`, `hiddden`) VALUES
(18, 9, 'Cesar', 'Vous n\'auriez pas vu mon Fils? ', '2019-09-06 18:13:09', NULL, NULL, NULL),
(19, 9, 'Novak Djokovic', 'J\'ai joué avec lui la semaine dernière ..', '2019-09-06 18:14:09', NULL, NULL, NULL),
(20, 9, 'Brutus', '@Cesar: tkt papa, jte rtrouve à la curie de Pompé, attends moi sur les marches!', '2019-09-06 18:16:03', NULL, NULL, NULL),
...
(27, 8, 'Claude', 'Si nous savions comment faire, c\'est vous que j\'aurai signalé @user2755', '2019-09-19 23:57:25', 0, NULL, NULL),
...
(32, 0, 'ju', 'C\'est nuuuuuuuuuull !', '2019-09-20 13:04:17', 0, NULL, 1);
